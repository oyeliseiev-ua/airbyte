...
public class SingleStoreInitialLoadRecordIterator extends AbstractIterator<JsonNode> implements AutoCloseableIterator<JsonNode> {
  ...
  SingleStoreInitialLoadRecordIterator(final JdbcDatabase database, final JdbcCompatibleSourceOperations<SingleStoreType> sourceOperations,
      final String quoteString, final SingleStoreInitialLoadStreamStateManager initialLoadStateManager, final List<String> columnNames,
      final AirbyteStreamNameNamespacePair pair, final long chunkSize, final boolean isCompositeKeyLoad) {
