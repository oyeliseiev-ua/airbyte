...
public class SingleStoreInitialLoadHandler {
  ...
  public SingleStoreInitialLoadHandler(final JsonNode config, final JdbcDatabase database, final SingleStoreSourceOperations sourceOperations,
      final String quoteString, final SingleStoreInitialLoadStreamStateManager initialLoadStateManager,
  ...
  public List<AutoCloseableIterator<AirbyteMessage>> getIncrementalIterators(final ConfiguredAirbyteCatalog catalog,
      final Map<String, TableInfo<CommonField<SingleStoreType>>> tableNameToTable, final Instant emittedAt) {
  ...
  private AutoCloseableIterator<AirbyteMessage> getRecordIterator(final AutoCloseableIterator<JsonNode> recordIterator, final String streamName,
      final String namespace, final long emittedAt) {
  ...
  private AutoCloseableIterator<AirbyteMessage> augmentWithState(final AutoCloseableIterator<AirbyteMessage> recordIterator,
      final ConfiguredAirbyteStream airbyteStream, final AirbyteStreamNameNamespacePair pair) {
