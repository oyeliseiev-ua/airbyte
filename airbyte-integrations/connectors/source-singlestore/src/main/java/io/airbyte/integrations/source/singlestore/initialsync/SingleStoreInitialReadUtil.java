...
public class SingleStoreInitialReadUtil {
  ...
  public static Map<io.airbyte.protocol.models.AirbyteStreamNameNamespacePair, PrimaryKeyInfo> initPairToPrimaryKeyInfoMap(
      final JdbcDatabase database, final InitialLoadStreams initialLoadStreams,
      final Map<String, TableInfo<CommonField<SingleStoreType>>> tableNameToTable, final String quoteString) {
  ...
  private static PrimaryKeyInfo getPrimaryKeyInfo(final JdbcDatabase database, final ConfiguredAirbyteStream stream,
      final Map<String, TableInfo<CommonField<SingleStoreType>>> tableNameToTable, final String quoteString) {
