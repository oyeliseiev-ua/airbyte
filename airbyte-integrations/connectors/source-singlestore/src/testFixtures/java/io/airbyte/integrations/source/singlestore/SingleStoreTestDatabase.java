...
public class SingleStoreTestDatabase extends TestDatabase<AirbyteSingleStoreTestContainer, SingleStoreTestDatabase, SingleStoreConfigBuilder> {
  ...
  public enum ContainerModifier implements NamedContainerModifier<AirbyteSingleStoreTestContainer> {
  ...
  public record Certificates(String caCertificate, String serverKey, String serverCert) {

  }

  static public class SingleStoreConfigBuilder extends ConfigBuilder<SingleStoreTestDatabase, SingleStoreConfigBuilder> {

    protected SingleStoreConfigBuilder(SingleStoreTestDatabase testDatabase) {
      super(testDatabase);
    }

    public SingleStoreConfigBuilder withStandardReplication() {
      return with("replication_method", "STANDARD");
    }
  }
}
